...
@Autonomous(name = "SetArmAutonomous1", group = "Autonomous")
public class SetArmAutonomous extends LinearOpMode {
    OpenCvCamera webcam;
    int zoneNumber = 0;
    ...
    public void runOpMode() throws InterruptedException {
       ...
       /* telemetry.addData("redvalue", signalPipeline.redColorValue);
        ...
        while (zoneNumber == 0 && opModeIsActive() && !isStopRequested()) {
            ...
            if (signalPipeline.blueColorValue > 90) {
                zoneNumber = 2;
        ...
        {
            case 3:
                move(1, 5.55, 1400, false);
                rotate(1,100);
                move(.75, .875, 1450, false);
                break;
            case 2:
                //move(.75, .655, 1500, false);
                move(.75, .865, 1500, false);
               break;
            case 1:
                move(1, 2.3, 1600, false);
                move(.75, .875, 1500, false);
                break;
        }
*/
