...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = .875; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double LATERAL_DISTANCE = 6.026; // in; distance between the left and right wheels
    ...
    public static double X_MULTIPLIER = 0.7886;
    public static double Y_MULTIPLIER = 1.598;
